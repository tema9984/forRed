...
@WebServlet("/create-empl")
public class CreateEmplServ extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        getServletContext().getRequestDispatcher("/createEmpl.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String mail = request.getParameter("surname");
            ...
            Employees employee = new Employees( name, mail, positions_id, department_id);
